  ...
  return (
    <div className={classes.wrapContent}>
      ...
      <div className={classes.text}>
        <p>Мне нравится обсуждать новые проекты и методики.</p>
        <p>
          Пожалуйста, поделитесь как можно большей информацией, чтобы я могла
          получить максимальную информацию о своей работе.
        </p>
      </div>
